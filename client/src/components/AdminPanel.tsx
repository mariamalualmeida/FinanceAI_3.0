        ...
        {editingConfig && (
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            <button
              ...
              className="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 bg-white dark:bg-gray-900 border border-gray-600 dark:border-gray-400 rounded-3xl transition-colors"
            >
              Cancelar
            </button>
            <button
              ...
              className="px-4 py-2 bg-white dark:bg-gray-900 border border-gray-600 dark:border-gray-400 text-gray-600 dark:text-gray-400 rounded-3xl hover:text-gray-800 dark:hover:text-gray-200 transition-colors"
            >
