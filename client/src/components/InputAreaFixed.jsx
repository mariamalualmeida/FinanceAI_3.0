        ...
        <div className="relative border border-gray-200 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-900 shadow-sm min-h-[80px]">
          ...
          <div className="relative border border-white dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-800 min-h-[100px] max-h-[180px] flex flex-col">
            ...
            <textarea
              ...
              className="flex-1 w-full resize-none border-0 outline-none bg-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 p-2 text-base leading-6 overflow-y-auto"
              onKeyDown={(e) => {
